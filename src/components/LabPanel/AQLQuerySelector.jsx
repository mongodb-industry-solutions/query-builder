...
const AQLQuerySelector = ({ onSelectQuery }) => {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="p-4 border-b border-slate-700">
        <h3 className="text-lg font-medium text-slate-200 mb-4">AQL Query Library</h3>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-slate-400">
            <TagIcon size={40} className="mb-4 opacity-50" />
          ...
          <div className="space-y-3">
            {filteredQueries.map(query => (
              <div
                key={query._id}
                className="bg-slate-800 border border-slate-700 rounded-lg p-3 hover:border-blue-500 cursor-pointer transition-colors"
...
AQLQuerySelector.propTypes = {
  onSelectQuery: PropTypes.func.isRequired
};

export default AQLQuerySelector;